...
const PlantillasLogin = () => {
  const [plantillasL, setPlantillasL] = useState([]);
  ...
  useEffect(() => {
    const fetchPlantillasLogin = async () => {
      try {
        const url =
          "https://raw.githubusercontent.com/EdgarBastidas/db_plantillas-web/main/login.json";
