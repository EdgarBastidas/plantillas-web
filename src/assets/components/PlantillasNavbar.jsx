...
const PlantillasNavbar = () => {
  const [plantillasN, setPlantillasN] = useState([]);
  ...
  useEffect(() => {
    const fetchPlantillasNavbar = async () => {
      try {
        const url =
          "https://raw.githubusercontent.com/EdgarBastidas/db_plantillas-web/main/navbar.json";
